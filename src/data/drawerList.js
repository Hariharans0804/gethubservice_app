import { Anchor, Angry, Anvil, Baby, Cable, Dam, Factory, Folder, Gem, Home, Layout, MSquare, Octagon, ShieldPlus } from 'lucide-react-native';
import { AboutScreen, BlogScreen, CreateSiteScreen, FeaturesScreen, GetStartedScreen, HomeScreen, IndustriesScreen, PricingScreen, SiteNeedsScreen, SupportScreen, TemplatesScreen, WhyChooseUsScreen } from '../screens';
